...
#define FAMILY_IS_GFX1154(f) FAMILY_IS(f, GFX1154)
...
#define AMDGPU_GFX1154_RANGE     0x01, 0x80 //# 01 <= x < 128
...
#define ASICREV_IS_GFX1154(r)          ASICREV_IS(r, GFX1154)
